...
module.exports = {
    offensivePlays: {
        "I-Formation": {
            ...
            "06": { x: -12, y: 0, h: 0, dv: 0, hb: false }, // Quarterback (QB)
            "07": { x: -3, y: 30, h: 0, dv: 0, hb: false }, // Tight End (TE)
            "08": { x: -16, y: -10, h: 0, dv: 0, hb: false }, // Running Back (RB)
        ...
        "Red - Shotgun": {
            ...
            "06": { x: -12, y: 0, h: 0, dv: 0, hb: false }, // Quarterback (QB)
            "07": { x: -3, y: 30, h: 0, dv: 0, hb: false }, // Tight End (TE)
            "08": { x: -10, y: -9, h: 0, dv: 0, hb: false }, // Running Back (RB)
            "09": { x: -16, y: 10, h: 0, dv: 0, hb: false }, // Fullback (FB)
            "10": { x: -3, y: -80, h: 0, dv: 0, hb: false }, // Wide Receiver 1 (WR1)
            "11": { x: -3, y: 80, h: 0, dv: 0, hb: false } // Wide Receiver 2 (WR2)
        },
        "Kickoff Return": {
